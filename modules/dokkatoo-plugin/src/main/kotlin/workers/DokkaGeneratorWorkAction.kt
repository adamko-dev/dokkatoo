...
/**
 * Gradle [WorkAction] for running [DokkaGenerator].
 *
 ...
 */
@DokkatooInternalApi
abstract class DokkaGeneratorWorkAction : WorkAction<DokkaGeneratorWorkAction.Parameters> {
  ...
  override fun execute() {
    ...
    executeDokkaGenerator(
      logFile = parameters.logFile.get().asFile,
      dokkaParameters = dokkaParameters,
    )
  }
