...
plugins {
  ...
  id("buildsrc.conventions.android-setup")
}
...
dependencies {
  testMavenPublication("dev.adamko.dokkatoo:dokkatoo-plugin")
  exampleProjects("dev.adamko.dokkatoo.examples:dokkatoo-examples")

  testFixturesApi(testFixtures("dev.adamko.dokkatoo:dokkatoo-plugin"))
